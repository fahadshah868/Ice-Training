...
Mobile.verifyElementText(findTestObject('CompetencyTraining/Validate_MarketIntelligenceScreen',[('package'):ProjectConstants.packagename]), 'Market Intelligence (Optional)')

Mobile.tap(findTestObject('CompetencyTraining/MarketIntelligenceTakePicture_ImageView',[('package'):ProjectConstants.packagename]), 0)
